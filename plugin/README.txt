...
* Enter a prompt and get a result!
* Choose a length of between 10 and 500 tokens
* Keep track of the last 10 items in your history
...
= Do I need an account with OpenAI? =
...
1. What it looks like to use the AI Writer.

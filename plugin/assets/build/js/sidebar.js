...
/* harmony import */ var _s_logo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./s-logo */ "./plugin/assets/src/js/s-logo.js");
...
var FJSidekickSidebar = /*#__PURE__*/function (_React$Component) {
  ...
  function FJSidekickSidebar(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setInitialState", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var user, lastIndex, lastItem;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              user = _context.sent;
              lastIndex = user.meta.fj_sidekick_history.items.length - 1;
              lastItem = user.meta.fj_sidekick_history.items[lastIndex];
    ...
    _defineProperty(_assertThisInitialized(_this), "warmUpEditEntityRecord", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              _context2.next = 4;
              return _this.props.editEntityRecord('root', 'user', 1, {});

            case 4:
              _context2.next = 6;
              return _this.props.saveEditedEntityRecord('root', 'user', 1);
    ...
    _defineProperty(_assertThisInitialized(_this), "onButtonClick", function () {
      ...
      var requestOptions = {
        ...
        headers: {
          ...
          Authorization: 'Bearer ' + _this.state.apiKey
        },
        body: JSON.stringify({
      ...
      fetch('https://api.openai.com/v1/completions', requestOptions).then(function (response) {
        ...
        var result = data && data.choices && data.choices[0] ? data.choices[0].text.trim() : '';
        ...
        _this.updatePrompt(_this.state.prompt);

        _this.addHistoryItem(_this.state.prompt, result);
      });
    });

    _defineProperty(_assertThisInitialized(_this), "updatePrompt", /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(prompt) {
        var user, currentHistory, currentMeta, meta;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                user = _context3.sent;
                currentHistory = user && user.meta && user.meta.fj_sidekick_history || [];
                currentMeta = user && user.meta || [];
                meta = _objectSpread(_objectSpread({}, currentMeta), {}, {
                  fj_sidekick_history: _objectSpread(_objectSpread({}, currentHistory), {}, {
                    last_prompt: prompt
                  })
                });
                _context3.next = 8;
                return _this.props.editEntityRecord('root', 'user', user.id, {
                  meta: meta
                });

              case 8:
                _context3.next = 10;
                return _this.props.saveEditedEntityRecord('root', 'user', user.id);
    ...
    _defineProperty(_assertThisInitialized(_this), "addHistoryItem", /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(prompt, result) {
        var user, currentItems, currentMeta, items, meta;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                user = _context4.sent;
                currentItems = user && user.meta && user.meta.fj_sidekick_history && user.meta.fj_sidekick_history.items || [];
                currentMeta = user && user.meta || [];
                items = [].concat(_toConsumableArray(currentItems), [{
                  prompt: prompt,
                  result: result,
              ...
              case 14:
                ...
                console.log('There was an error saving the history item.', _context4.t0);
  ...
  _createClass(FJSidekickSidebar, [{
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return this.warmUpEditEntityRecord();
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement((react__WEBPACK_IMPORTED_MODULE_5___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
      ...
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.RangeControl, {
      ...
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Get Content', 'fj-sidekick')), this.state.loading && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Spinner, null), this.state.result && !this.state.loading && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement((react__WEBPACK_IMPORTED_MODULE_5___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.__experimentalDivider, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextareaControl, {
        ...
        onClick: function onClick() {
          return navigator.clipboard.writeText(_this3.state.result);
        },
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_0__.registerPlugin)('fj-sidekick-sidebar', {
  icon: _s_logo__WEBPACK_IMPORTED_MODULE_6__["default"],
